...
import static com.example.asutosh.aebug.CreateTicket.memberlistview1;
...
public class Create_asMemAdapter extends BaseAdapter {
    ...
    public Create_asMemAdapter(Activity activity, List<member_assigned_bean> tlist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Create_asMemAdapter.this.notifyDataSetChanged();
            }
        });
