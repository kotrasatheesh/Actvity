...
public class IEdit_areaAdapter extends BaseAdapter {
    ...
    public IEdit_areaAdapter(Activity activity, List<Areabean> tlist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                IEdit_areaAdapter.this.notifyDataSetChanged();
            }
        });
